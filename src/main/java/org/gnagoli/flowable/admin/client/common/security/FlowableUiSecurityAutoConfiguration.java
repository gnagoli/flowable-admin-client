...
import org.gnagoli.flowable.admin.client.common.rest.idm.CurrentUserProvider;
import org.gnagoli.flowable.admin.client.common.rest.idm.OAuth2CurrentUserProvider;
...
import org.gnagoli.flowable.admin.client.common.service.idm.cache.RemoteIdmUserCache;
...
public class FlowableUiSecurityAutoConfiguration {
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnMissingClass("org.gnagoli.flowable.admin.client.idm.logic.service.GroupServiceImpl")
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "org.gnagoli.flowable.admin.client.idm.logic.service.GroupServiceImpl")
